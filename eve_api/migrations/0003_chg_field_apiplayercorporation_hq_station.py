...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ApiPlayerCorporation.hq_station'
        db.alter_column('eve_api_apiplayercorporation', 'hq_station_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eve_db.StaStation'], null=True))


    def backwards(self, orm):
        
        # Changing field 'ApiPlayerCorporation.hq_station'
        db.alter_column('eve_api_apiplayercorporation', 'hq_station_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['eve_db.StaStation']))
    ...
    models = {
        ...
        'eve_api.apiplayercorporation': {
            ...
            'hq_station': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eve_db.StaStation']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
